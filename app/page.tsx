...
import { Upload, User, Shirt, Sparkles, Check, Loader2, Zap, Brain, AlertCircle, Info } from 'lucide-react'
                ...
                <Card>
                  ...
                  <CardContent>
                    <Select value={selectedModel} onValueChange={setSelectedModel}>
                      ...
                      <SelectContent>
                        <SelectItem value="fal-ai">
                          <div className="flex items-center gap-3 py-2">
                            <Zap className="w-4 h-4 text-purple-600" />
                            <div className="flex-1">
                              <div className="flex items-center gap-2">
                                <span className="font-medium">Fal AI FASHN v1.6</span>
                                <span className="text-xs px-2 py-1 bg-green-100 text-green-800 rounded-full">
                                  Recommended
                                </span>
                              </div>
                              <p className="text-xs text-gray-500 mt-1">
                                Specialized virtual try-on model with realistic garment fitting
                              </p>
                            </div>
                          </div>
                        </SelectItem>
                        <SelectItem value="openai">
                          <div className="flex items-center gap-3 py-2">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-gray-500 mt-1">
                                Advanced image editing with precise clothing application
                              </p>
                            </div>
                          </div>
                        </SelectItem>
